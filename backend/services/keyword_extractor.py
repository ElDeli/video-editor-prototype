...
class KeywordExtractor:
    ...
    def extract_visual_scenes(self, text: str, topic: str = None) -> List[Dict]:
        """
        ...
        Args:
            ...
            topic: Optional topic/title for context (improves visual relevance)
        """
        scenes = []
        ...
        print(f"\n📝 Auto-creating {len(sentences)} scenes from script{topic_info}...")
        ...
        for idx, sentence in enumerate(sentences, 1):
            ...
            visual_prompt = self._extract_visual_concept(sentence, topic=topic)
    ...
    def _extract_visual_concept(self, sentence: str, topic: str = None) -> str:
        """
        ...
        Args:
            sentence: The sentence to extract visual concept from
            topic: Optional topic/title for context (e.g., "Climate Change", "Motivation for Men")
...
Topic: Motivation for Men
Sentence: "Du hast die Kraft zu kämpfen"
Good: "strong man silhouette mountain peak sunrise powerful stance"

Topic: Climate Change & Geoengineering
Sentence: "Darf der Mensch eingreifen?"
Good: "scientist at climate control panel facing ethical decision"

Topic: Viral Philosophy Content
Sentence: "Was ist die Lösung?"
Good: "philosopher contemplating solution with glowing enlightenment"
"""

                # Build user message with optional topic context
                if topic:
                    user_message = f"Topic: {topic}\n\nSentence: {sentence}"
                    print(f"🎨 Generating 3 keyword variations for: '{sentence[:50]}...' (Topic: {topic})")
                else:
